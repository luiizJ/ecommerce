...
import { calcJuros, formatPrice } from "@/Utils/calcJuros";
  ...
  return (
    <div className="product-page">
        ...
        <div className="product-details">
          ...
          <div className="price-section">
            ...
            <span className="discount">
              À vista no Pix com{" "}
              <span style={{ fontWeight: "bold" }}>10% de Desconto</span>
            </span>
            <span className="installments">
              ...
              <span style={{ fontWeight: "bold" }}>
                {" "}
                R$ {formatPrice(calcJuros({ price: product.price }))}
              </span>{" "}
              sem juros no cartão
            </span>
          </div>
          ...
          <div className="cep-section">
            ...
            <div className="cep-input-group">
              <input id="cep-input" type="text" placeholder="00000-000" />
      ...
      <details className="accordion">
        ...
        <p>
          {product.name} é um produto de alta qualidade, desenvolvido para
          atender aos usuários mais exigentes...
        </p>
      </details>
              ...
              <div className="related-info">
                ...
                <div className="price-section">
                  ...
                  <span className="installments">
                    ...
                    <span style={{ fontWeight: "bold" }}>
                      {" "}
                      R$ {formatPrice(calcJuros({ price: rel.price }))}
                    </span>{" "}
                    sem juros no cartão
                  </span>
                </div>
