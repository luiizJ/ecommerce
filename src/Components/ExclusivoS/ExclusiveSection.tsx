        ...
        <div className="produtoEx">
          <div className="left-slide">
            <div className="productCenter">
              ...
              <p>
                o GT62VR 6RE Dominator PRO é uma opção interessante para quem
                quer uma melhor experiência em games. A máquina possui uma GPU
                Nvidia Geforce GTX 1070 que, segundo a fabricante, consegue
                rodar sem travamentos os jogos da atualidade e também os de
                realidade virtual.
              </p>
            </div>
